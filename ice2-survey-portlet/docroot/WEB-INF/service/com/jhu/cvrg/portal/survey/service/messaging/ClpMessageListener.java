...
package com.jhu.cvrg.portal.survey.service.messaging;

import com.jhu.cvrg.portal.survey.service.ClpSerializer;
...
public class ClpMessageListener implements MessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			SurveyQuestionOptionLocalServiceUtil.clearService();
