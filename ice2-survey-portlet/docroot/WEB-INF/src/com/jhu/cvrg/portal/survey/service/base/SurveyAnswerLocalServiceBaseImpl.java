...
/**
 * The base implementation of the survey answer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.jhu.cvrg.portal.survey.service.impl.SurveyAnswerLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link com.jhu.cvrg.portal.survey.service.SurveyAnswerLocalServiceUtil} to access the survey answer local service.
 * </p>
 *
 * @author Chris Jurado
...
public abstract class SurveyAnswerLocalServiceBaseImpl
	implements SurveyAnswerLocalService {
	/**
	...
	public SurveyAnswer addSurveyAnswer(SurveyAnswer surveyAnswer)
		...
		return surveyAnswerPersistence.update(surveyAnswer, false);
	}
	...
	public void deleteSurveyAnswer(long surveyAnswerId)
		...
		surveyAnswerPersistence.remove(surveyAnswerId);
	}
	...
	public void deleteSurveyAnswer(SurveyAnswer surveyAnswer)
		throws SystemException {
		surveyAnswerPersistence.remove(surveyAnswer);
	}
	...
	public SurveyAnswer updateSurveyAnswer(SurveyAnswer surveyAnswer)
		...
		return surveyAnswerPersistence.update(surveyAnswer, true);
	}
	...
	public SurveyAnswer updateSurveyAnswer(SurveyAnswer surveyAnswer,
		...
		return surveyAnswerPersistence.update(surveyAnswer, merge);
	}
