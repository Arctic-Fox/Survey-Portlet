...
/**
 * The base implementation of the survey local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.jhu.cvrg.portal.survey.service.impl.SurveyLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link com.jhu.cvrg.portal.survey.service.SurveyLocalServiceUtil} to access the survey local service.
 * </p>
 *
 * @author Chris Jurado
...
public abstract class SurveyLocalServiceBaseImpl implements SurveyLocalService {
	 ...
	 */
	public Survey createSurvey(long surveyId) {
		return surveyPersistence.create(surveyId);
	}
	...
	public void deleteSurvey(long surveyId)
		...
		surveyPersistence.remove(surveyId);
	}
	...
	public Survey getSurvey(long surveyId)
		throws PortalException, SystemException {
		return surveyPersistence.findByPrimaryKey(surveyId);
	}
